...
(function (b, d) {
  ...
  b.Widget.prototype = {
    ...
    _trigger: function (e, f, g) {
      ...
      return !(
        (b.isFunction(h) && h.call(this.element[0], f, g) === false) ||
      ...
      var e = this,
        ...
        d =
          typeof this.options.cancel == "string" && f.target.nodeName
            ? b(f.target).closest(this.options.cancel).length
            : false;
...
(function (c, d) {
  c.widget("ui.resizable", c.ui.mouse, {
    ...
    _mouseStop: function (h) {
      ...
      if (this._helper) {
        ...
        var n = { width: m.helper.width() - k, height: m.helper.height() - f },
          j =
            parseInt(m.element.css("left"), 10) +
              (m.position.left - m.originalPosition.left) || null,
          l =
            parseInt(m.element.css("top"), 10) +
              (m.position.top - m.originalPosition.top) || null;
        if (!i.animate) {
    ...
    _proportionallyResize: function () {
      ...
      for (var f = 0; f < this._proportionallyResizeElements.length; f++) {
        ...
        if (
          c.browser.msie &&
          !!(c(g).is(":hidden") || c(g).parents(":hidden").length)
        ) {
          continue;
        }
        h.css({
    ...
    _change: {
      ...
      se: function (g, f, e) {
        return c.extend(
          ...
          this._change.e.apply(this, [g, f, e]),
        );
      },
      sw: function (g, f, e) {
        return c.extend(
          this._change.s.apply(this, arguments),
          this._change.w.apply(this, [g, f, e]),
        );
      },
      ne: function (g, f, e) {
        return c.extend(
          ...
          c(m).each(function () {
            var q = c(this),
              ...
              o =
                n && n.length
                  ? n
                  : q.parents(i.originalElement[0]).length
                    ? ["width", "height"]
  ...
  c.ui.plugin.add("resizable", "containment", {
    start: function (f, r) {
      ...
      var g = j.containment,
        k =
          g instanceof c ? g.get(0) : /parent/.test(g) ? l.parent().get(0) : g;
      if (!k) {
        return;
      }
    ...
    resize: function (g, q) {
      ...
      if (n.left < (t._helper ? p.left : 0)) {
        t.size.width =
          t.size.width +
          (t._helper ? t.position.left - p.left : t.position.left - e.left);
        if (r) {
      ...
      if (n.top < (t._helper ? p.top : 0)) {
        t.size.height =
          t.size.height + (t._helper ? t.position.top - p.top : t.position.top);
        if (r) {
      ...
      var l = Math.abs(
          (t._helper ? t.offset.left - e.left : t.offset.left - e.left) +
            t.sizeDiff.width,
        ),
        s = Math.abs(
          (t._helper ? t.offset.top - e.top : t.offset.top - p.top) +
            t.sizeDiff.height,
        );
  ...
  c.ui.plugin.add("resizable", "grid", {
    resize: function (e, m) {
      ...
      var g =
          Math.round((k.width - i.width) / (h.grid[0] || 1)) * (h.grid[0] || 1),
        f =
          Math.round((k.height - i.height) / (h.grid[1] || 1)) *
          (h.grid[1] || 1);
      if (/^(se|s|e)$/.test(n)) {
      ...
      .each(function () {
        ...
        c.each(d.axis.split(""), function (q, r) {
          ...
          if (i) {
            ...
            var t = k[u];
            g[p] =
              t.slice && t.slice(-1) == "%" ? (parseFloat(t) / 100) * n : t;
          }
          if (/^\d+$/.test(g[p])) {
...
(function (a) {
  ...
  function x(Q) {
    ...
    function M() {
      if (
        !c.isFixedTipOpen &&
        (c.isTipOpen || (c.tipOpenImminent && O.data(u)))
      ) {
        var R = O.outerWidth(),
          V = O.outerHeight(),
          U = new b(),
    ...
    function J() {
      ...
      if (c.isTipOpen && !c.isClosing && !c.delayInProgress) {
        if (c.activeHover.data(e) === false || c.activeHover.is(":disabled")) {
          ...
          if (
            !v(c.activeHover) &&
            !c.activeHover.is(":focus") &&
            !c.activeHover.data(d)
          ) {
            if (O.data(f)) {
              if (!v(O)) {
                R = true;
...
(function (a) {
          ...
          [
            [
              ...
              function (s) {
                ...
                if (l) {
                  var q = Math.abs(l.x - t.x),
                    p = Math.abs(l.y - t.y);
                  if (
                    (q > 0 || p > 0) &&
                    q <= 2 &&
                    p <= 2 &&
                    t.timeStamp - l.timeStamp <= 300
                  ) {
                    f = true;
                    if (o) {
                      var r = a(s.target).closest("a");
                      if (r.is("a")) {
                        a.each(b, function () {
                          if (a.contains(this.$root[0], r[0])) {
                            this.itemEnter({ currentTarget: r[0] });
                            return false;
                          }
                        });
                      }
  ...
  function j(l) {
    return !/^(4|mouse)$/.test(l.pointerType);
  }
  function i(l, n) {
    if (!n) {
      n = "";
    ...
    a.each(l, function (o, p) {
      m[p[0].split(" ").join(n + " ") + n] = p[1];
    });
    return m;
  }
  a.SmartMenus = function (m, l) {
    this.$root = a(m);
    this.opts = l;
    this.rootId = "";
    this.accessIdPrefix = "";
    ...
    this.cssTransforms3d =
      "perspective" in m.style || "webkitPerspective" in m.style;
    ...
    prototype: {
      init: function (n) {
        ...
        if (!n) {
          ...
          a(window).bind(
            i([["resize orientationchange", a.proxy(this.winResize, this)]], r),
          );
        ...
        if (this.opts.markCurrentItem) {
          var p = /(index|default)\.[^#\?\/]*/i,
            m = /#.*/,
            q = window.location.href.replace(p, ""),
            o = q.replace(m, "");
          this.$root.find("a").each(function () {
            var s = this.href.replace(p, ""),
              t = a(this);
            if (s == q || s == o) {
              t.addClass("current");
              if (l.opts.markCurrentTree) {
                t.parentsUntil("[data-smartmenus-id]", "ul").each(function () {
      ...
      destroy: function (m) {
        ...
        this.$root
          ...
          .each(function () {
            var o = a(this);
            if (o.dataSM("scroll-arrows")) {
              o.dataSM("scroll-arrows").remove();
            }
            if (o.dataSM("shown-before")) {
              if (l.opts.subMenusMinWidth || l.opts.subMenusMaxWidth) {
                o.css({ width: "", minWidth: "", maxWidth: "" }).removeClass(
                  "sm-nowrap",
                );
              }
              if (o.dataSM("scroll-arrows")) {
            ...
            if ((o.attr("id") || "").indexOf(l.accessIdPrefix) == 0) {
              o.removeAttr("id");
            }
          })
      ...
      disable: function (l) {
        if (!this.disabled) {
          this.menuHideAll();
          if (!l && !this.opts.isPopup && this.$root.is(":visible")) {
            var m = this.$root.offset();
      ...
      docClick: function (l) {
        ...
        if (
          (this.visibleSubMenus.length &&
            !a.contains(this.$root[0], l.target)) ||
          a(l.target).is("a")
        ) {
          this.menuHideAll();
        }
      },
      docTouchEnd: function (m) {
        if (!this.lastTouch) {
          return;
        }
        if (
      ...
      getClosestMenu: function (m) {
        var l = a(m).closest("ul");
        while (l.dataSM("in-mega")) {
          l = l.parent().closest("ul");
        }
        return l[0] || null;
      },
      getHeight: function (l) {
        return this.getOffset(l, true);
      },
      getOffset: function (n, l) {
        ...
        var o = n[0].getBoundingClientRect && n[0].getBoundingClientRect(),
          p =
            o &&
            (l ? o.height || o.bottom - o.top : o.width || o.right - o.left);
        if (!p && p !== 0) {
          p = l ? n[0].offsetHeight : n[0].offsetWidth;
        }
        if (m) {
          n.hide().css(m);
        }
      ...
      getStartZIndex: function (l) {
        var m = parseInt(this[l ? "$root" : "$firstSub"].css("z-index"));
        if (!l && isNaN(m)) {
          m = parseInt(this.$root.css("z-index"));
        }
        return !isNaN(m) ? m : 1;
      },
      getTouchPoint: function (l) {
        return (
      ...
      getViewport: function (l) {
        var m = l ? "Height" : "Width",
          o = document.documentElement["client" + m],
          n = window["inner" + m];
        if (n) {
          o = Math.min(o, n);
        }
      ...
      getWidth: function (l) {
        return this.getOffset(l);
      },
      handleEvents: function () {
        return !this.disabled && this.isCSSOn();
      },
      handleItemEvents: function (l) {
        return this.handleEvents() && !this.isLinkInMegaMenu(l);
      },
      ...
      isLinkInMegaMenu: function (l) {
        return a(this.getClosestMenu(l[0])).hasClass("mega-menu");
      },
      isTouchMode: function () {
        return !f || this.opts.noMouseOver || this.isCollapsible();
      },
      itemActivate: function (p, l) {
        var n = p.closest("ul"),
          q = n.dataSM("level");
        if (
          q > 1 &&
          (!this.activatedItems[q - 2] ||
            this.activatedItems[q - 2][0] != n.dataSM("parent-a")[0])
        ) {
          var m = this;
          a(n.parentsUntil("[data-smartmenus-id]", "ul").get().reverse())
            .add(n)
            .each(function () {
              m.itemActivate(a(this).dataSM("parent-a"));
            });
        }
        if (!this.isCollapsible() || l) {
          this.menuHideSubMenus(
            !this.activatedItems[q - 1] || this.activatedItems[q - 1][0] != p[0]
              ? q - 1
              : q,
          );
        }
        this.activatedItems[q - 1] = p;
        if (this.$root.triggerHandler("activate.smapi", p[0]) === false) {
          return;
        }
        var o = p.dataSM("sub");
        if (
      ...
      itemClick: function (o) {
        ...
        if (
          ...
          this.$touchScrollingSub[0] == n.closest("ul")[0]
        ) {
          this.$touchScrollingSub = null;
          o.stopPropagation();
          return false;
        ...
        var p = a(o.target).is("span.sub-arrow"),
          m = n.dataSM("sub"),
          l = m ? m.dataSM("level") == 2 : false;
        if (m && !m.is(":visible")) {
          if (this.opts.showOnClick && l) {
        ...
        if (
          (this.opts.showOnClick && l) ||
          n.hasClass("disabled") ||
          this.$root.triggerHandler("select.smapi", n[0]) === false
        ) {
          return false;
        }
      },
      itemDown: function (m) {
        ...
        l.dataSM("mousedown", true);
      },
      itemEnter: function (n) {
        var m = a(n.currentTarget);
        if (!this.handleItemEvents(m)) {
          return;
        }
        if (!this.isTouchMode()) {
          if (this.showTimeout) {
          ...
          this.showTimeout = setTimeout(
            ...
            this.opts.showOnClick && m.closest("ul").dataSM("level") == 1
              ? 1
      ...
      itemFocus: function (m) {
        ...
        if (
          this.focusActivated &&
          (!this.isTouchMode() || !l.dataSM("mousedown")) &&
          (!this.activatedItems.length ||
            this.activatedItems[this.activatedItems.length - 1][0] != l[0])
        ) {
          this.itemActivate(l, true);
        }
        this.$root.triggerHandler("focus.smapi", l[0]);
      },
      itemLeave: function (m) {
        var l = a(m.currentTarget);
        if (!this.handleItemEvents(l)) {
          return;
        }
        ...
        l.removeDataSM("mousedown");
        this.$root.triggerHandler("mouseleave.smapi", l[0]);
      },
      menuHide: function (m) {
        if (this.$root.triggerHandler("beforehide.smapi", m[0]) === false) {
          return;
        }
        m.stop(true, true);
        if (m.css("display") != "none") {
          ...
          if (this.isCollapsible()) {
            if (this.opts.collapsibleHideFunction) {
              this.opts.collapsibleHideFunction.call(this, m, l);
            } else {
              m.hide(this.opts.collapsibleHideDuration, l);
            }
          } else {
            if (this.opts.hideFunction) {
              this.opts.hideFunction.call(this, m, l);
            } else {
              m.hide(this.opts.hideDuration, l);
            }
          }
          if (m.dataSM("ie-shim")) {
            m.dataSM("ie-shim")
      ...
      menuHideAll: function () {
        ...
        for (var l = this.visibleSubMenus.length - 1; l >= m; l--) {
          this.menuHide(this.visibleSubMenus[l]);
        }
      ...
      menuHideSubMenus: function (n) {
        for (var l = this.activatedItems.length - 1; l >= n; l--) {
          var m = this.activatedItems[l].dataSM("sub");
          if (m) {
            this.menuHide(m);
          }
        }
      },
      menuIframeShim: function (l) {
      ...
      menuInit: function (l) {
        if (!l.dataSM("in-mega")) {
          if (l.hasClass("mega-menu")) {
            l.find("ul").dataSM("in-mega", true);
          }
          var q = 2,
            m = l[0];
          while ((m = m.parentNode.parentNode) != this.$root[0]) {
            q++;
          }
          var n = l.prevAll("a").eq(-1);
          if (!n.length) {
            n = l.prevAll().find("a").eq(-1);
          }
          n.addClass("has-submenu").dataSM("sub", l);
          l.dataSM("parent-a", n).dataSM("level", q).parent().dataSM("sub", l);
          ...
          if (this.opts.subIndicators) {
            n[this.opts.subIndicatorsPos](this.$subArrow.clone());
          }
        }
      },
      menuPosition: function (K) {
        var r = K.dataSM("parent-a"),
          D = r.closest("li"),
          E = D.parent(),
          l = K.dataSM("level"),
          t = this.getWidth(K),
          ...
          v = H.scrollLeft(),
          s = H.scrollTop(),
          z = this.getViewportWidth(),
          L = this.getViewportHeight(),
          w =
            E.parent().is("[data-sm-horizontal-sub]") ||
            (l == 2 && !E.hasClass("sm-vertical")),
          B =
            (this.opts.rightToLeftSubMenus && !D.is("[data-sm-reverse]")) ||
            (!this.opts.rightToLeftSubMenus && D.is("[data-sm-reverse]")),
          p =
            l == 2
        ...
        if (this.opts.keepInViewport) {
          ...
          if ((w && (M + J > s + L + 0.49 || M < s)) || (!w && J > L + 0.49)) {
            var G = this;
            if (!K.dataSM("scroll-arrows")) {
              K.dataSM(
                "scroll-arrows",
                a([
                  a(
                  ...
                  .bind({
                    mouseenter: function () {
                      K.dataSM("scroll").up = a(this).hasClass("scroll-up");
                      G.menuScroll(K);
                    },
                    ...
                    "mousewheel DOMMouseScroll": function (x) {
                      x.preventDefault();
                    },
                  })
                  .insertAfter(K),
            ...
            K.dataSM("scroll", {
              y: this.cssTransforms3d ? 0 : A - F,
              step: 1,
              itemH: F,
              subH: J,
              arrowDownH: this.getHeight(K.dataSM("scroll-arrows").eq(1)),
            })
              .bind(
                i(
                  [
              ...
              .css({
                top: "auto",
                left: "0",
                marginLeft: C + (parseInt(K.css("border-left-width")) || 0),
                width:
                  t -
                  (parseInt(K.css("border-left-width")) || 0) -
                  (parseInt(K.css("border-right-width")) || 0),
      ...
      menuScroll: function (r, m, n) {
        var p = r.dataSM("scroll"),
          q = r.dataSM("scroll-arrows"),
          o = p.up ? p.upEnd : p.downEnd,
          s;
        if (!m && p.momentum) {
          p.momentum *= 0.92;
          s = p.momentum;
          ...
          s =
            n ||
            (m || !this.opts.scrollAccelerate
              ? this.opts.scrollStep
              : Math.floor(p.step));
        }
        var l = r.dataSM("level");
        if (
          this.activatedItems[l - 1] &&
          this.activatedItems[l - 1].dataSM("sub") &&
          this.activatedItems[l - 1].dataSM("sub").is(":visible")
        ) {
          this.menuHideSubMenus(l - 1);
        }
        p.y =
          (p.up && o <= p.y) || (!p.up && o >= p.y)
            ? p.y
            : Math.abs(o - p.y) > s
              ? p.y + (p.up ? s : -s)
              : o;
        r.add(r.dataSM("ie-shim")).css(
          this.cssTransforms3d
            ? {
                "-webkit-transform": "translate3d(0, " + p.y + "px, 0)",
                transform: "translate3d(0, " + p.y + "px, 0)",
              }
            : { marginTop: p.y },
        );
        if (f && ((p.up && p.y > p.downEnd) || (!p.up && p.y < p.upEnd))) {
          q.eq(p.up ? 1 : 0).show();
        }
        if (p.y == o) {
          if (f) {
          ...
          if (!m) {
            if (this.opts.scrollAccelerate && p.step < this.opts.scrollStep) {
              p.step += 0.2;
            }
            var t = this;
            this.scrollTimeout = g(function () {
              t.menuScroll(r);
            });
          }
        }
      },
      menuScrollMousewheel: function (m, n) {
        if (this.getClosestMenu(n.target) == m[0]) {
          n = n.originalEvent;
          ...
          if (
            ...
            m.dataSM("scroll").up = l;
            this.menuScroll(m, true);
          }
        }
        n.preventDefault();
      },
      menuScrollOut: function (l, m) {
        if (f) {
          if (
            !/^scroll-(up|down)/.test((m.relatedTarget || "").className) &&
            ((l[0] != m.relatedTarget && !a.contains(l[0], m.relatedTarget)) ||
              this.getClosestMenu(m.relatedTarget) != l[0])
          ) {
            l.dataSM("scroll-arrows").css("visibility", "hidden");
          }
        }
      },
      menuScrollOver: function (n, o) {
        if (f) {
          if (
            !/^scroll-(up|down)/.test(o.target.className) &&
            this.getClosestMenu(o.target) == n[0]
          ) {
            this.menuScrollRefreshData(n);
            var m = n.dataSM("scroll"),
              l =
                a(window).scrollTop() -
                n.dataSM("parent-a").offset().top -
                m.itemH;
            n.dataSM("scroll-arrows")
              .eq(0)
              .css("margin-top", l)
              .end()
              .eq(1)
              .css("margin-top", l + this.getViewportHeight() - m.arrowDownH)
              .end()
              .css("visibility", "visible");
          }
        }
      },
      menuScrollRefreshData: function (n) {
        var m = n.dataSM("scroll"),
          l =
            a(window).scrollTop() - n.dataSM("parent-a").offset().top - m.itemH;
        if (this.cssTransforms3d) {
          l = -(parseFloat(n.css("margin-top")) - l);
        }
        a.extend(m, {
          upEnd: l,
          downEnd: l + this.getViewportHeight() - m.subH,
        });
      },
      menuScrollStop: function (l) {
        if (this.scrollTimeout) {
          c(this.scrollTimeout);
          this.scrollTimeout = 0;
          l.dataSM("scroll").step = 1;
          return true;
        }
      },
      menuScrollTouch: function (p, q) {
        q = q.originalEvent;
        if (j(q)) {
          var m = this.getTouchPoint(q);
          if (this.getClosestMenu(m.target) == p[0]) {
            var o = p.dataSM("scroll");
            if (/(start|down)$/i.test(q.type)) {
              if (this.menuScrollStop(p)) {
                q.preventDefault();
              ...
              a.extend(o, {
                touchStartY: m.pageY,
                touchStartTime: q.timeStamp,
              });
            } else {
              if (/move$/i.test(q.type)) {
                var n = o.touchY !== undefined ? o.touchY : o.touchStartY;
                if (n !== undefined && n != m.pageY) {
                  this.$touchScrollingSub = p;
                  var l = n < m.pageY;
                  if (o.up !== undefined && o.up != l) {
                    a.extend(o, {
                      touchStartY: m.pageY,
                      touchStartTime: q.timeStamp,
                    });
                ...
                if (o.touchY !== undefined) {
                  if (
                    (o.momentum =
                      Math.pow(
                        Math.abs(m.pageY - o.touchStartY) /
                          (q.timeStamp - o.touchStartTime),
                        2,
                      ) * 15)
                  ) {
      ...
      menuShow: function (n) {
        if (!n.dataSM("beforefirstshowfired")) {
          n.dataSM("beforefirstshowfired", true);
          if (
            this.$root.triggerHandler("beforefirstshow.smapi", n[0]) === false
          ) {
            return;
          }
        }
        if (this.$root.triggerHandler("beforeshow.smapi", n[0]) === false) {
          return;
        }
        n.dataSM("shown-before", true).stop(true, true);
        if (!n.is(":visible")) {
          var m = n.dataSM("parent-a");
          if (this.opts.keepHighlighted || this.isCollapsible()) {
            m.addClass("highlighted");
          }
          if (this.isCollapsible()) {
            n.removeClass("sm-nowrap").css({
              zIndex: "",
              width: "auto",
              minWidth: "",
              maxWidth: "",
            ...
            if (this.opts.subMenusMinWidth || this.opts.subMenusMaxWidth) {
              n.css({ width: "auto", minWidth: "", maxWidth: "" }).addClass(
                "sm-nowrap",
              );
            ...
            this.menuPosition(n);
            if (n.dataSM("ie-shim")) {
              n.dataSM("ie-shim").insertBefore(n);
            }
          }
          var l = function () {
            n.css("overflow", "");
          ...
          if (this.isCollapsible()) {
            if (this.opts.collapsibleShowFunction) {
              this.opts.collapsibleShowFunction.call(this, n, l);
            } else {
              n.show(this.opts.collapsibleShowDuration, l);
            }
          } else {
            if (this.opts.showFunction) {
              this.opts.showFunction.call(this, n, l);
            } else {
              n.show(this.opts.showDuration, l);
            }
          }
      ...
      popupShow: function (o, n) {
        ...
        if (!this.$root.is(":visible")) {
          ...
          if (this.opts.showFunction) {
            this.opts.showFunction.call(this, this.$root, l);
          } else {
            this.$root.show(this.opts.showDuration, l);
          }
      ...
      rootKeyDown: function (o) {
        if (!this.handleEvents()) {
          return;
        }
        switch (o.keyCode) {
          case 27:
            var m = this.activatedItems[0];
            if (m) {
              this.menuHideAll();
              m[0].focus();
              var n = m.dataSM("sub");
          ...
          case 32:
            var l = a(o.target);
            if (l.is("a") && this.handleItemEvents(l)) {
              var n = l.dataSM("sub");
              if (n && !n.is(":visible")) {
                this.itemClick({ currentTarget: o.target });
                o.preventDefault();
              }
            }
            break;
      ...
      winResize: function (m) {
        ...
        if (
          ...
          var l = this.isCollapsible();
          if (!(this.wasCollapsible && l)) {
  ...
  a.fn.dataSM = function (l, m) {
    if (m) {
      return this.data(l + "_smartmenus", m);
    }
    return this.data(l + "_smartmenus");
  };
  a.fn.removeDataSM = function (l) {
    return this.removeData(l + "_smartmenus");
  };
  a.fn.smartmenus = function (m) {
    if (typeof m == "string") {
      var l = arguments,
        o = m;
      Array.prototype.shift.call(l);
      return this.each(function () {
        var p = a(this).data("smartmenus");
        if (p && p[o]) {
          p[o].apply(p, l);
        }
      });
    }
    var n = a.extend({}, a.fn.smartmenus.defaults, m);
    return this.each(function () {
      new a.SmartMenus(this, n);
    });
  };
  a.fn.smartmenus.defaults = {
    ...
    showFunction: null,
    hideDuration: 0,
    hideFunction: function (m, l) {
      m.fadeOut(200, l);
    },
    collapsibleShowDuration: 0,
    collapsibleShowFunction: function (m, l) {
      m.slideDown(200, l);
    },
    collapsibleHideDuration: 0,
    collapsibleHideFunction: function (m, l) {
      m.slideUp(200, l);
    },
    showOnClick: false,
    hideOnClick: true,

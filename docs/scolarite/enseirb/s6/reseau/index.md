...
description: "Cours d'introduction aux réseaux du semestre 6 : historique, classification, modèles OSI et TCP/IP, réseaux locaux et Ethernet."
---
...
base sur Ethernet (adressage, commutation, types Ethernet), équipements
d'interconnexion réseau, autres protocoles pour les LAN, travaux pratiques.

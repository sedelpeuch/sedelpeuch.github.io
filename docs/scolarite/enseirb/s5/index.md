---
title: Semestre 5
description: Présentation des cours du semestre 5 de l'ENSEIRB-MATMECA en filière informatique (algorithmique, mathématiques, programmation, environnement de travail) et liens vers les supports.
---
...
manipulés sont de types simples (entiers, réels, etc.) ou des tableaux et matrices de
...
+ d'une part, familiariser l'étudiant avec les principales méthodes factorielles
...
+ d'autre part, familiariser les étudiants avec le logiciel R de plus en plus
...
probabilités, qui seront utilisées dans d'autres enseignements à l'ENSEIRB-MATMECA :
...
+ introduction à l'évolution de la structure des ordinateurs ;
...
La scolarité de première année à l'ENSEIRB-MATMECA, en filière informatique, comprend

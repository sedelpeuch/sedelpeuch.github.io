...
**Entité :** une population d'individus homogène
...
1. *Créez un modèle conceptuel qui permet de modéliser correctement le système d'information nécessaire sachant
   ...
   + *Un client peut bien sûr recevoir plusieurs factures, mais il est uniquement considéré comme tel à partir
     du moment où il reçoit sa première facture.*
...
On vous demande de concevoir un système d'information traitant de gestion de personnel sur le plan de
...
heures attribuées à un projet. Un employé peut avoir des personnes à charge, représentées chacune par un nom, une

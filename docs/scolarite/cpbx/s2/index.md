...
- [TD, prise de notes](chimie/orga/td.pdf)
...
- [Fiche résumant le cours](physique/Fiche-Thermodynamique.pdf)
...
- [Fiche résumant le cours](physique/Fiche-Optique.pdf)
...
ans. Voici une proposition de solution. Faites attention à la partie
mécanique, la théorie est juste mais la pratique possède plusieurs défauts.

<ResourceList type="correction">

- [Proposition de solution des TP](physique/TP.pdf)

</ResourceList>

En complément, une proposition de compte rendu pour le deuxième TP d'optique.

<ResourceList type="tp" title="Comptes rendus">

- [Compte rendu du deuxième TP d'optique](physique/optique.pdf)

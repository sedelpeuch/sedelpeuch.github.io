...
<ProjectLinks>
  <ProjectLink to="/docs/projects/professionnel/cicd" title="CI/CD - Workflows GitHub Actions mutualisés">Jobs des workflows mutualisés (tests pytest, compilation ROS et Zephyr, publication d'images Docker), exécutés sur les runners auto-hébergés ARC du cluster interne.</ProjectLink>
</ProjectLinks>

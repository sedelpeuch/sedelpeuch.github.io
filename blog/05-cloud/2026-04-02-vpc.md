...
<ProjectLinks>
  <ProjectLink to="/docs/projects/personnel/task-horizon" title="TaskHorizon">VPC dédié provisionné par Terraform en `eu-west-3`, avec deux sous-réseaux publics et deux privés sur deux zones de disponibilité, tags `kubernetes.io/role/elb` et `kubernetes.io/role/internal-elb`, et NAT Gateway unique pour la sortie des nœuds privés.</ProjectLink>
</ProjectLinks>

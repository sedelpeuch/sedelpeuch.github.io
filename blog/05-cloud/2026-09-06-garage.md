...
Sans versioning, une suppression libère réellement l'espace, sans marqueur résiduel (le piège inverse, sur un fournisseur versionné, est décrit dans l'article [docker-volume-backup](../03-containerization/2026-09-13-docker-volume-backup.md)). Les notions S3 génériques sont présentées dans [AWS : RDS, S3 et EBS](2026-03-28-aws-storage.md).
...
Voir [l'introduction à Prometheus](../07-monitoring/2025-11-21-prometheus-introduction.md) et [Alertmanager](../07-monitoring/2026-09-20-alertmanager.md) pour la chaîne d'alerte.

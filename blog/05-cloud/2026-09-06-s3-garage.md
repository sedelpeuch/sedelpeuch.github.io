...
<ProjectLinks>
  <ProjectLink to="/docs/projects/personnel/homelab" title="HomeLab">Instance Garage à nœud unique (métadonnées sur NVMe, données sur une baie RAID) servant de seconde copie locale des sauvegardes de volumes, provisionnée par l'API admin v2, avec un bucket sous quota réservé à la copie hors site d'un site partenaire.</ProjectLink>
</ProjectLinks>

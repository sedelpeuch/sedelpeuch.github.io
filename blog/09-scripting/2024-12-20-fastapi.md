...
<ProjectLinks>
  <ProjectLink to="/docs/projects/personnel/dolibarr_project_dashboard" title="Dolibarr Project Dashboard">Backend FastAPI du dashboard organisé en trois couches (routes, services, infrastructure), qui agrège les données de l'API REST Dolibarr au travers de clients httpx.</ProjectLink>
  <ProjectLink to="/docs/projects/professionnel/outils-internes" title="Automatisation du quotidien — outils internes SONU">Application jira-dashboard FastAPI + React qui expose les tickets par période, une heatmap annuelle de charge et la répartition par utilisateur.</ProjectLink>
</ProjectLinks>

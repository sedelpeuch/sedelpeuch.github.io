...
**Utilisation** : Docker comme runtime pour tous les conteneurs exécutés dans le cluster Kubernetes (Grafana, Portainer, etc.).

### [GitHub ARC Kubeadm](/docs/projects/professionnel/github-arc-kubeadm)
**Utilisation** : Runtime Docker pour les conteneurs des runners GitHub Actions sur Kubernetes.

### [CI/CD](/docs/projects/professionnel/cicd)
**Utilisation** : Fondation pour les pipelines CI/CD : construction d'images et déploiement de conteneurs.

### [body_analysis](/docs/projects/personnel/body_analysis)
**Utilisation** : Application Streamlit containerisée pour le suivi personnel et déploiement.

### [dolibarr_project_dashboard](/docs/projects/personnel/dolibarr_project_dashboard)
**Utilisation** : FastAPI backend et frontend React containerisés pour déploiement local et Docker.
